...
namepart1 = "cytC.STED-enh2x.tiff" // the image which is opened first - cytC or Tom20; in any case the confocal channel
namepart2 = "Bax.STED_BG-20._enh99.9_Gauss2.tiff"
namepart3 = "Bak.STED_BG-20._enh99.9_Gauss2.tiff"
...
for (i = 0; i < subDirlist.length; i++) {
	...
	for (j = 0; j < filelist.length; j++) {
		...
		if(endsWith(filename, namepart1)) {
			...
			save_title = replace(title1, "cytC", "merge");
